...
#
#  Be sure to run `pod spec lint QBImagePickerController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of QBImagePickerController in Markdown format.
  ...
  s.homepage     = "http://EXAMPLE/QBImagePickerController"
  ...
  s.author       = { "tiponche" => "tiponche@gmail.com" }
  # s.authors      = { "tiponche" => "tiponche@gmail.com", "other author" => "email@address.com" }
  # s.author       = 'tiponche', 'other author'
  ...
  s.source       = { :git => "http://EXAMPLE/QBImagePickerController.git", :tag => "0.0.1" }
